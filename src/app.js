...
const CAT_I18N = {
  '粉紅醬麵':{ja:'ピンクソースパスタ',ko:'핑크소스 파스타'},
  '紅醬麵':{ja:'トマトソースパスタ',ko:'토마토소스 파스타'},
  '白醬麵':{ja:'クリームソースパスタ',ko:'크림소스 파스타'},
  '辣奶油麵':{ja:'スパイシークリームパスタ',ko:'스파이시 크림 파스타'},
  '青醬麵':{ja:'ペストパスタ',ko:'페스토 파스타'},
  '米型麵':{ja:'オルゾパスタ',ko:'오르조'},
  '清炒麵':{ja:'炒めパスタ',ko:'볶음 파스타'},
  '漢堡':{ja:'バーガー',ko:'버거'},
  '漢堡加點':{ja:'バーガー追加',ko:'버거 추가'},
  '升級套餐':{ja:'アップグレードセット',ko:'업그레이드 세트'},
  '炸物':{ja:'揚げ物',ko:'튀김'},
  '湯品':{ja:'スープ',ko:'수프'},
  '飲品':{ja:'ドリンク',ko:'음료'},
  '咖啡':{ja:'コーヒー',ko:'커피'},
  '康普茶':{ja:'コンブチャ',ko:'콤부차'},
  '精釀啤酒':{ja:'クラフトビール',ko:'크래프트 맥주'},
};
const NAME_I18N = {
  '粉紅肉醬洋菇義大利麵':{ja:'ミートソース＆マッシュルームのピンクパスタ',ko:'핑크소스 미트소스 버섯 파스타'},
  '粉紅菌菇雞肉義大利麵':{ja:'チキン＆きのこのピンクパスタ',ko:'핑크소스 버섯 치킨 파스타'},
  '粉紅鮮蝦干貝義大利麵':{ja:'海老＆ホタテのピンクパスタ',ko:'핑크소스 새우 가리비 파스타'},
  '茄汁肉醬義大利麵':{ja:'ミートソーストマトパスタ',ko:'토마토 미트소스 파스타'},
  '茄汁菌菇雞肉義大利麵':{ja:'チキン＆きのこのトマトパスタ',ko:'토마토소스 버섯 치킨 파스타'},
  '番茄海鮮義大利麵':{ja:'海鮮トマトパスタ',ko:'해산물 토마토 파스타'},
  '蛋汁奶油培根義大利麵':{ja:'カルボナーラ',ko:'카르보나라'},
  '奶油菌菇雞肉義大利麵':{ja:'チキン＆きのこのクリームパスタ',ko:'크림소스 버섯 치킨 파스타'},
  '奶油海鮮義大利麵':{ja:'海鮮クリームパスタ',ko:'해산물 크림 파스타'},
  '奶油鮮蔬義大利麵':{ja:'野菜のクリームパスタ',ko:'채소 크림 파스타'},
  '辣奶油菌菇雞肉義大利麵':{ja:'チキン＆きのこのスパイシークリームパスタ',ko:'스파이시 크림 버섯 치킨 파스타'},
  '辣奶油海鮮義大利麵':{ja:'海鮮スパイシークリームパスタ',ko:'해산물 스파이시 크림 파스타'},
  '青醬培根義大利麵':{ja:'ベーコンのペストパスタ',ko:'베이컨 페스토 파스타'},
  '青醬雞肉義大利麵':{ja:'チキンペストパスタ',ko:'치킨 페스토 파스타'},
  '青醬海鮮義大利麵':{ja:'海鮮ペストパスタ',ko:'해산물 페스토 파스타'},
  '粉紅菌菇雞肉米型麵':{ja:'チキン＆きのこのピンクオルゾ',ko:'핑크소스 버섯 치킨 오르조'},
  '松露野菇米型麵':{ja:'トリュフ野生きのこオルゾ',ko:'트러플 야생버섯 오르조'},
  '青醬培根米型麵':{ja:'ベーコンペストオルゾ',ko:'베이컨 페스토 오르조'},
  '義式巴薩米可雞柳米型麵':{ja:'バルサミコチキンオルゾ',ko:'발사믹 치킨 오르조'},
  '清炒鮮蔬義大利麵':{ja:'野菜の炒めパスタ',ko:'채소 볶음 파스타'},
  '蒜頭小魚乾辣椒麵':{ja:'ガーリックアンチョビチリパスタ',ko:'마늘 멸치 고추 파스타'},
  '蒜香梅花豬義大利麵':{ja:'ガーリックポークパスタ',ko:'마늘 돼지고기 파스타'},
  '白酒蛤蜊義大利麵':{ja:'アサリの白ワインパスタ',ko:'바지락 화이트와인 파스타'},
  '招牌Joyful花生牛肉起司堡（附脆薯）':{ja:'看板ピーナッツビーフチーズバーガー（フライ付き）',ko:'시그니처 땅콩 비프 치즈버거（감자튀김 포함）'},
  '焦糖海鹽熔岩炸雞堡（附脆薯）':{ja:'キャラメル塩チキンバーガー（フライ付き）',ko:'캐러멜 소금 치킨 버거（감자튀김 포함）'},
  '經典肉醬牛肉起司堡（附脆薯）':{ja:'クラシックミートソースビーフバーガー（フライ付き）',ko:'클래식 미트소스 비프 버거（감자튀김 포함）'},
  '罪純粹牛肉起司堡（附脆薯）':{ja:'ピュアビーフチーズバーガー（フライ付き）',ko:'순수 비프 치즈버거（감자튀김 포함）'},
  '傲椒薯餅青醬炒菇堡 素（附脆薯）':{ja:'ベジハッシュブラウンペストバーガー（フライ付き）',ko:'채식 해시브라운 페스토 버거（감자튀김 포함）'},
  '墨西哥辣椒蕈菇牛肉起司堡（附脆薯）':{ja:'ハラペーニョきのこビーフバーガー（フライ付き）',ko:'할라피뇨 버섯 비프 버거（감자튀김 포함）'},
  '塔塔巧滋蟹肉魚排堡（附脆薯）':{ja:'タルタルクラブフィッシュバーガー（フライ付き）',ko:'타르타르 크랩 피시버거（감자튀김 포함）'},
  '加美式炒蛋':{ja:'スクランブルエッグ追加',ko:'스크램블에그 추가'},
  'A 套餐：濃湯 ＋ 飲品':{ja:'Aセット：スープ＋ドリンク',ko:'A 세트: 수프＋음료'},
  'B 套餐：炸物 ＋ 飲品':{ja:'Bセット：揚げ物＋ドリンク',ko:'B 세트: 튀김＋음료'},
  'C 套餐：洋蔥圈或雞柳 ＋ 湯 ＋ 飲品':{ja:'Cセット：オニオンリングまたはチキンストリップ＋スープ＋ドリンク',ko:'C 세트: 어니언링 또는 치킨스트립＋수프＋음료'},
  '黃金脆薯':{ja:'ゴールデンフライ',ko:'황금 감자튀김'},
  '美式炸薯球':{ja:'ポテトボール',ko:'감자볼'},
  '美式雞塊':{ja:'チキンナゲット',ko:'치킨 너겟'},
  '熔岩起司脆薯':{ja:'とろけるチーズフライ',ko:'녹은 치즈 감자튀김'},
  '松露薯條':{ja:'トリュフフライ',ko:'트러플 감자튀김'},
  '經典肉醬起司脆薯':{ja:'ミートソースチーズフライ',ko:'미트소스 치즈 감자튀김'},
  '經典洋蔥圈':{ja:'クラシックオニオンリング',ko:'클래식 어니언링'},
  '美式雞柳條':{ja:'チキンストリップス',ko:'치킨 스트립'},
  '揪福雞翅':{ja:'ジョイフルチキンウィング',ko:'조이풀 치킨윙'},
  '任性三拼盤':{ja:'三品盛り合わせ',ko:'트리오 플래터'},
  '玉米濃湯':{ja:'コーンスープ',ko:'옥수수 수프'},
  '紅茶':{ja:'紅茶',ko:'홍차'},
  '奶茶':{ja:'ミルクティー',ko:'밀크티'},
  '無糖綠茶':{ja:'無糖緑茶',ko:'무설탕 녹차'},
  '可樂':{ja:'コーラ',ko:'콜라'},
  '雪碧':{ja:'スプライト',ko:'스프라이트'},
  '蘋果汁':{ja:'アップルジュース',ko:'사과주스'},
  '可爾必思':{ja:'カルピス',ko:'칼피스'},
  '可可亞':{ja:'ココア',ko:'코코아'},
  '玉米鬚茶':{ja:'コーンシルクティー',ko:'옥수수수염차'},
  '美式咖啡':{ja:'アメリカーノ',ko:'아메리카노'},
  '拿鐵':{ja:'ラテ',ko:'라테'},
  '卡布奇諾':{ja:'カプチーノ',ko:'카푸치노'},
  '接骨木蘋果康普茶':{ja:'エルダーフラワーアップルコンブチャ',ko:'엘더플라워 애플 콤부차'},
  '有機高山葡萄康普茶':{ja:'オーガニックグレープコンブチャ',ko:'유기농 포도 콤부차'},
  '白毫茉莉康普茶':{ja:'ジャスミンコンブチャ',ko:'자스민 콤부차'},
  '鐵觀音康普茶':{ja:'鉄観音コンブチャ',ko:'철관음 콤부차'},
  '吐司去邊大冰紅啤酒':{ja:'レッドエール',ko:'레드에일'},
  '芭樂鹽小麥啤酒':{ja:'グアバソルトウィートビール',ko:'구아바 소금 밀맥주'},
  '浪花朵朵啤酒':{ja:'泡波ビール',ko:'파도 맥주'},
  '極夏365啤酒':{ja:'サマービール365',ko:'여름 365 맥주'},
  '撥雲見日萊姆仙島':{ja:'ライムサワービール',ko:'라임 사워 맥주'},
};
...
function m(obj) { return obj[lang] || obj.en || obj.zh; }
function mc(item, field) {
  if (lang === 'zh' || lang === 'en') return m(item[field]);
  if (field === 'cat') { const c = CAT_I18N[item.cat.zh]; return (c && c[lang]) || m(item[field]); }
  if (field === 'name') { const n = NAME_I18N[item.name.zh]; return (n && n[lang]) || m(item[field]); }
  return m(item[field]);
}
function geo() {
...
function renderMenu() {
  ...
  const card = i => `<div class="menu-card${i.tag?.includes('★')?' mc-rec':''}">
    <div class="mc-top"><div class="mc-cat">${mc(i,'cat')}</div>${i.tag?`<div class="mc-badge">${i.tag}</div>`:''}</div>
    <div class="mc-name">${mc(i,'name')}</div>
    <div class="mc-desc">${mc(i,'desc')}</div>
